...
\cite{Fulcher2013} has an associated Matlab-based code package,
\emph{hctsa}, that extracts thousands of structural features from a time
series and determines which are most useful for a given scientific task.
...
we want to demonstrate a feasible pathway for incorporating these useful
features into the Nitime package.
